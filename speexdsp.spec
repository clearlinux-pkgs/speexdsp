...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656515370
...
cp %{_builddir}/speexdsp-1.2.1/COPYING %{buildroot}/usr/share/package-licenses/speexdsp/fc3b9b42abbb2f2b795ad9598708f3db0b3e9ae7
pushd ../build32/
%make_install32
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libspeexdsp.so.1.5.2
/usr/lib64/glibc-hwcaps/x86-64-v4/libspeexdsp.so.1
/usr/lib64/glibc-hwcaps/x86-64-v4/libspeexdsp.so.1.5.2
